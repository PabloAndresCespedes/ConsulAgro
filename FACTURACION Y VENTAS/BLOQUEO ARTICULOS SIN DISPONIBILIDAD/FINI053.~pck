          ...
          select fd.doc_nro_doc,
            ...
            */
            ...
            select fd.doc_nro_doc,
                   ...
                   and fd.doc_mon = '||in_mnd||'
                   and fd.doc_empr = '||in_empresa||'
                   and (trunc(fd.doc_fec_doc) between to_date('||to_char(in_desde, 'dd/mm/yyyy')||', ''dd/mm/yyyy'') and to_date('||to_char(in_desde, 'dd/mm/yyyy')||', ''dd/mm/yyyy''))
                   and fc.cuo_saldo_mon > 0
                   '|| case 
                        when in_tipo_mov = l_recibo_nc_emitido then
                           'and fd.doc_tipo_mov in ('||l_nc_emitida||', '||l_nc_emi_ajuste||')' 

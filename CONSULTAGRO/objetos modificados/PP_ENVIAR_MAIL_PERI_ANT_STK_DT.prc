create or replace procedure PP_ENVIAR_MAIL_PERI_ANT_STK_DT(P_CLAVE       IN NUMBER DEFAULT NULL,
...
BEGIN
  ...
  if DESTINATARIO is not null then
    ...
    UTL_MAIL.SEND(sender     => 'noreply',
                      ...
                      message    => saludo || '.
Se a ' || TIPO ||
                                     ' Una Factura Detalle de Stock del Mes Anterior Tenga Cuidado,Para Que No Haya Diferencia. ' ||
...
end PP_ENVIAR_MAIL_PERI_ANT_STK_DT;
/
